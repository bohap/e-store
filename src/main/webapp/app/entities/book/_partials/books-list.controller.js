(function() {
	...
	BooksListController.$inject = ['ConfirmDialog', 'PromotionDialog', 'toastr', 'Promotion', 'Principal'];

	function BooksListController(ConfirmDialog, PromotionDialog, toastr, Promotion, Principal) {
		var vm = this;
