...
var appBasePath = 'src/main/webapp/app/';
var testBasePath = 'src/test/javascript/';

module.exports = function(config) {
	config.set({

		// base path that will be used to resolve all patterns (eg. files, exclude)
		basePath: testBasePath.replace(/[^/]+/g, '..'),
		...
		files: [
			...
			// endbower
			appBasePath + 'app.module.js',
			appBasePath + '**/*.js',
			testBasePath + 'spec/**/*.spec.js'
		],
